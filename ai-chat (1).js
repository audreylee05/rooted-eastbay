  ...
  async function sendMessage(text) {
    ...
    try {
      const res = await fetch('https://api.anthropic.com/v1/messages', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', 'x-api-key': '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', 'anthropic-version': '2023-06-01', 'anthropic-dangerous-direct-browser-access': 'true' },
        body: JSON.stringify({
