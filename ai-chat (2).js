  ...
  async function sendMessage(text) {
    ...
    try {
      const res = await fetch('https://api.anthropic.com/v1/messages', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', 'x-api-key': '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', 'anthropic-version': '2023-06-01', 'anthropic-dangerous-direct-browser-access': 'true' },
        body: JSON.stringify({
